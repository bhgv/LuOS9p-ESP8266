...
CFLAGS += -DluaTaskStack=192*6-50 #85 #97 #+7 #8 #8 #5               # Stck size assigned to lua thread
CFLAGS += -DtskDEF_PRIORITY=10				 # Default task priority
CFLAGS += -DdefaultThreadStack=192*6-50 #85 #97 #+7 #8 #8 #5
#CFLAGS += -DCONFIG_LUA_RTOS_LUA_THREAD_STACK_SIZE=192*7 #5
#CFLAGS += -DCONFIG_LUA_RTOS_LUA_TASK_PRIORITY=20
#CFLAGS += -D
#CFLAGS += -D
...
CFLAGS += -D_NO_GETPWENT=1

#CFLAGS += -DportREMOVE_STATIC_QUALIFIER -DINCLUDE_pcTaskGetTaskName=1 -DGDBSTUB=1 

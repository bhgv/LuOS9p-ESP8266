...
static lpeg_Instruction *prepcompile (lua_State *L, Pattern *p, int idx) {
...
static int lp_match (lua_State *L) {
  ...
  lpeg_Instruction *code = (p->code != NULL) ? p->code : prepcompile(L, p, 1);
...
const LUA_REG_TYPE metareg[] = {
  { LSTRKEY( "__mul" ),  LFUNCVAL( lp_seq ) },
  { LSTRKEY( "__add" ),  LFUNCVAL( lp_choice) },
  { LSTRKEY( "__pow" ),  LFUNCVAL( lp_star) },
  { LSTRKEY( "__gc" ),  LFUNCVAL( lp_gc) },
  { LSTRKEY( "__len" ),  LFUNCVAL( lp_and) },
  { LSTRKEY( "__div" ),  LFUNCVAL( lp_divcapture) },
  { LSTRKEY( "__unm" ),  LFUNCVAL( lp_not) },
  { LSTRKEY( "__sub" ),  LFUNCVAL( lp_sub) },
  { LSTRKEY( "__sub" ),  LFUNCVAL( lp_sub) },
  
  { LSTRKEY( "__index" ),  LROVAL( metareg) },
  { LNILKEY, LNILVAL }
};


const LUA_REG_TYPE pattreg[] = {
  { LSTRKEY( "ptree" ),  LFUNCVAL( lp_printtree) },
  { LSTRKEY( "pcode" ),  LFUNCVAL( lp_printcode) },
  { LSTRKEY( "match" ),  LFUNCVAL( lp_match) },
  { LSTRKEY( "B" ),  LFUNCVAL( lp_behind) },
  { LSTRKEY( "V" ),  LFUNCVAL( lp_V) },
  { LSTRKEY( "C" ),  LFUNCVAL( lp_simplecapture) },
  { LSTRKEY( "Cc" ),  LFUNCVAL( lp_constcapture) },
  { LSTRKEY( "Cmt" ),  LFUNCVAL( lp_matchtime) },
  { LSTRKEY( "Cb" ),  LFUNCVAL( lp_backref) },
  { LSTRKEY( "Carg" ),  LFUNCVAL( lp_argcapture) },
  { LSTRKEY( "Cp" ),  LFUNCVAL( lp_poscapture) },
  { LSTRKEY( "Cs" ),  LFUNCVAL( lp_substcapture) },
  { LSTRKEY( "Ct" ),  LFUNCVAL( lp_tablecapture) },
  { LSTRKEY( "Cf" ),  LFUNCVAL( lp_foldcapture) },
  { LSTRKEY( "Cg" ),  LFUNCVAL( lp_groupcapture) },
  { LSTRKEY( "P" ),  LFUNCVAL( lp_P) },
  { LSTRKEY( "S" ),  LFUNCVAL( lp_set) },
  { LSTRKEY( "R" ),  LFUNCVAL( lp_range) },
  { LSTRKEY( "locale" ),  LFUNCVAL( lp_locale) },
  { LSTRKEY( "version" ),  LFUNCVAL( lp_version) },
  { LSTRKEY( "setmaxstack" ),  LFUNCVAL( lp_setmax) },
  { LSTRKEY( "type" ),  LFUNCVAL( lp_type) },
  
  { LSTRKEY( "__metatable" ),  LROVAL( metareg) },
  { LNILKEY, LNILVAL }
};
...
int luaopen_lpeg (lua_State *L) {
//  luaL_newmetatable(L, PATTERN_T);
  luaL_newmetarotable(L, PATTERN_T, (void*)metareg );
...
MODULE_REGISTER_MAPPED(LPEG, peg, pattreg, luaopen_lpeg);

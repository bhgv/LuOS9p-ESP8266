...
static const lpeg_Instruction giveup = {{IGiveup, 0, 0}};
...
typedef struct Stack {
  ...
  const lpeg_Instruction *p;  /* next instruction */
  int caplevel;
} Stack;
...
const char *match (lua_State *L, const char *o, const char *s, const char *e,
                   lpeg_Instruction *op, Capture *capture, int ptop) {
  ...
  const lpeg_Instruction *p = op;  /* current instruction */

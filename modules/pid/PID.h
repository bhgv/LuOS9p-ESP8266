...
typedef struct pid_controller * pid_ctl_t;
...
extern "C" {
	 ...
	 *
	 * @return returns a pid_ctl_t controller handle
	 */
	 ...
	 */
	bool pid_need_compute(pid_ctl_t pid);
	 ...
	 */
	void pid_tune(pid_ctl_t pid, float kp, float ki, float kd);
	 ...
	 */
	void pid_limits(pid_ctl_t pid, float min, float max);
	 ...
	 */
	void pid_direction(pid_ctl_t pid, enum pid_control_directions dir);

...
ssd1306_2_SRC_DIR = $(ssd1306_2_ROOT)

ssd1306_2_CFLAGS = -DSSD1306_I2C_SUPPORT=${SSD1306_I2C_SUPPORT} -DSSD1306_SPI4_SUPPORT=${SSD1306_SPI4_SUPPORT} $(CFLAGS)


$(eval $(call component_compile_rules,ssd1306_2))

 ...
 * @return Non-zero if error occured
 */
inline int ssd1306_clear_screen(uint8_t addr)
{
    return ssd1306_load_frame_buffer(addr, NULL);
}
 ...
 * @return Non-zero if error occured
 */
int ssd1306_draw_line(uint8_t addr, uint8_t *fb, int16_t x0, int16_t y0, int16_t x1, int16_t y1, ssd1306_color_t color);
 ...
 * @return Non-zero if error occured
 */
int ssd1306_draw_triangle(uint8_t addr, uint8_t *fb, int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, ssd1306_color_t color);
 ...
 * @return Non-zero if error occured
 */
int ssd1306_fill_triangle(uint8_t addr, uint8_t *fb, int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, ssd1306_color_t color);
 ...
 */
int ssd1306_draw_char(uint8_t addr, uint8_t *fb, const font_info_t *font, uint8_t x, uint8_t y, char c, ssd1306_color_t foreground, ssd1306_color_t background);
 ...
 */
int ssd1306_draw_string(uint8_t addr, uint8_t *fb, const font_info_t *font, uint8_t x, uint8_t y, char *str, ssd1306_color_t foreground, ssd1306_color_t background);
